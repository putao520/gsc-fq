...
```bash
docker pull ghcr.io/putao520/gsc-fq:v0.9.3
docker run -v $(pwd)/config.toml:/app/config.toml ghcr.io/putao520/gsc-fq:v0.9.3
```
...
**Linux** (x86_64):
```bash
wget https://github.com/putao520/gsc-fq/releases/download/v0.9.3/gsc-fq-linux-x86_64.tar.gz
...
**Linux** (aarch64):
```bash
wget https://github.com/putao520/gsc-fq/releases/download/v0.9.3/gsc-fq-linux-aarch64.tar.gz
...
**macOS** (Intel):
```bash
wget https://github.com/putao520/gsc-fq/releases/download/v0.9.3/gsc-fq-macos-x86_64.tar.gz
...
**macOS** (Apple Silicon):
```bash
wget https://github.com/putao520/gsc-fq/releases/download/v0.9.3/gsc-fq-macos-aarch64.tar.gz
...
**Windows** (x86_64):
```powershell
# Download from: https://github.com/putao520/gsc-fq/releases/download/v0.9.3/gsc-fq-windows-x86_64.zip
...
| Metric | GSC-FQ v0.9.3 | Nginx (stream) | HAProxy | socat |
|--------|--------------|---------------|---------|-------|
...
docker run -d \
  ...
  -p 8080:8080 \
  ghcr.io/putao520/gsc-fq:v0.9.3
```
